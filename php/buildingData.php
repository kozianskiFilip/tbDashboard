...
if($h>=6 && $h<14)
{
    ...
    $shift_end="to_date('".$end."  14:00:00','yy-mm-dd hh24:mi:ss') ";
...
if($h>=14 && $h<22)
{
    ...
    $shift_end="to_date('".$end."  22:00:00','yy-mm-dd hh24:mi:ss') ";
    $start_hr=14;
    $end_hr=22;
    $zmiana=2;
...
if($h>=22 || $h<6)
{
    if($h>=22)
    {
        ...
        $shift_end="to_date('".$end."  06:00:00','yy-mm-dd hh24:mi:ss') ";
        $start_plan_konf=new DateTime();
        $start_plan_konf=date_format ($start_plan_konf, 'Ymd');
    }
    if($h<=6)
...
$stidCurResults = oci_parse($ffmesConnection,"select output,pred,plan_excel_total,prod,inv_ok,inv_nok,bc3_output,bc3_pred,bc3_schedule,transport,total,PLAN_EXCEL_1,PLAN_EXCEL_2,PLAN_EXCEL_3 from
                                            (
                                                ...
                                                (
                                                    ...
                                                    where
                                                    sched_date='".$start_plan_konf."' and shift in (".$zmiana.") and code like 'PL-GT0%' and group_id_00='WBR'
                                                )on 1=1
                                                left join
                                                (
                                                    ...
                                                    where 
                                                    dstamp between ".$date_range."
                                                ) on 1=1
                                                where obszar='TOTAL' and dstamp between ".$date_range." order by dstamp desc
                                            ) where rownum=1");
...
$stidNoTires = oci_parse($ffmesConnection, $text="select 
                                                    trunc(sum((down_edt-down_sdt)*24),2) SUMA,
                                                    TOTAL,
                                                    BT3, TRANSPORT
                                                    from
                                                    (
                                                        select 
                                                          resrce,
                                                          case when down_sdt< to_date('".$start." ".$start_hr.":00:00','yy-mm-dd hh24:mi:ss') then to_date('".$start." ".$start_hr.":00:00','yy-mm-dd hh24:mi:ss') else down_sdt end down_sdt,
                                                          case when down_edt>to_date('".$end." ".$end_hr.":00:00','yy-mm-dd hh24:mi:ss') then to_date('".$end." ".$end_hr.":00:00','yy-mm-dd hh24:mi:ss') else down_edt end down_edt,
                                                        ...
                                                        (
                                                          down_sdt between to_date('".$start." ".$start_hr.":00:00','yy-mm-dd hh24:mi:ss') and to_date('".$end." ".$end_hr.":00:00','yy-mm-dd hh24:mi:ss')
                                                          or down_edt between to_date('".$start." ".$start_hr.":00:00','yy-mm-dd hh24:mi:ss') and to_date('".$end." ".$end_hr.":00:00','yy-mm-dd hh24:mi:ss')
                                                          or (down_sdt <= to_date('".$start." ".$start_hr.":00:00','yy-mm-dd hh24:mi:ss') and down_edt >= to_date('".$end." ".$end_hr.":00:00','yy-mm-dd hh24:mi:ss'))
                                                        ...
                                                        (
                                                          down_sdt between to_date('".$start." ".$start_hr.":00:00','yy-mm-dd hh24:mi:ss') and to_date('".$end." ".$end_hr.":00:00','yy-mm-dd hh24:mi:ss')
                                                          or (down_sdt <= to_date('".$start." ".$start_hr.":00:00','yy-mm-dd hh24:mi:ss'))
                                                        ) and cure_prod_down.down_code='16100'
                                                    ) S1
                                                    ...
                                                    (
                                                        ...
                                                        from cure_prod_down_notires@curemes
                                                        where 
                                                        dstamp between to_date('".$start." ".$start_hr.":00:00', 'yy-mm-dd hh24:mi:ss') and to_date('".$end." ".$end_hr.":00:00', 'yy-mm-dd hh24:mi:ss') and resrce not like 'R%'
                                                    ) on 1=1
